...
public class ReusableMethods {
    ...
    public static void tumSayfaFotografCek(WebDriver driver) {
        ...
        String tarihEtiketi = "TumSayfa" + ldt.getYear() + ldt.getMonthValue()
                + ldt.getDayOfMonth() + ldt.getHour() + ldt.getMinute() + ".png";
        String path = "target/Screenshot/" + tarihEtiketi;
    ...
    public static void webelementFotografCek(WebDriver driver, WebElement webElement) {
        ...
        File geciciElement = webElement.getScreenshotAs(OutputType.FILE);


        try {
            FileUtils.copyFile(geciciElement,element);
        } catch (IOException e) {
